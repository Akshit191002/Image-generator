                ...
                <div className="image-generator-main-container">
                    <div className='image-search'>
                        ...
                        {searchText && imageSrc1 &&
                            // <img className="img-style" src={`https://source.unsplash.com/random/400x400/?${searchText}`} />
                            <img className="img-style" src={`https://loremflickr.com/400/400/${searchText}`} />
                            // <img className="img-style" src={`https://pixabay.com/api/?key=44283691-d31556bd17c64ad86d1a9888c&q=${searchText}`} />
                        }
                    </div>
